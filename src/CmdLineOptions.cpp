    ...
    CmdLineOptions::CmdLineOptions(int acc, const char *avv[]) {
        ...
        desc.add_options()
                ...
                ("enable-emission-monitor", value<bool>()->default_value(false)->implicit_value(true),
                 "enable Sispop total emission monitoring thread")
                ...
                ("bc-path,b", value<string>(),
                 "path to lmdb folder of the blockchain, e.g., ~/.sispop/lmdb")
                ...
                ("daemon-url,d", value<string>()->default_value("http:://127.0.0.1:30000"),
                 "Sispop daemon url")
