...
MempoolStatus::read_mempool()
{
    ...
    for (size_t i = 0; i < mempool_tx_info.size(); ++i)
    {
        ...
        double payed_for_kB = SISPOP_AMOUNT(_tx_info.fee) / tx_size;
...
bf::path MempoolStatus::blockchain_path {"/home/mwo/.sispop/lmdb"};
string MempoolStatus::daemon_url {"http:://127.0.0.1:30000"};
