...
/**
* Parse sispop address in a string form into
...
/**
* Return string representation of sispop address
*/
string
...
{
    // default path to sispop folder
    // on linux this is /home/<username>/.sispop
    string default_sispop_dir = tools::get_default_data_dir();

    if (nettype == cryptonote::network_type::TESTNET)
        default_sispop_dir += "/testnet";
    if (nettype == cryptonote::network_type::STAGENET)
        default_sispop_dir += "/stagenet";


    // the default folder of the lmdb blockchain database
    // is therefore as follows
    return default_sispop_dir + string("/lmdb");
}
