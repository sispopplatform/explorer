...
#ifndef SISPOPEG01_TOOLS_H
#define SISPOPEG01_TOOLS_H
...
{
    return SISPOP_AMOUNT(core_amount);
}
                  ...
                  bool zero_to_question_mark=true)
{
    ...
    {
        amount_str = fmt::format(_format, SISPOP_AMOUNT(lok_amount));
    }
    else
    {
